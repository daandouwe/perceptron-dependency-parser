...
def load_conllu(file):
    ...
    file_line = 0  # Added by Daan van Stigt
    while True:
        line = file.readline()
        if not line:
            break
        ...
        file_line += 1  # Added by Daan van Stigt
            ...
            def process_word(word):
                ...
                if word.parent is None:
                    ...
                    if head < 0 or head > len(ud.words) - sentence_start:
                        ...
                        raise UDError("HEAD '{}' points outside of the sentence (line {})".format(word.columns[HEAD], file_line))
                    if head:
        ...
        # Basic tokens/words
            ...
            if word_id != len(ud.words) - sentence_start + 1:
                ...
                raise UDError("Incorrect word ID '{}' for word '{}', expected '{}' (line {})".format(columns[ID], columns[FORM], len(ud.words) - sentence_start + 1, file_line))
